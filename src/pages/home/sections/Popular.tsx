            ...
            <div className="flex flex-wrap justify-center lg:justify-between px-[10vw] mt-[25px]">
                {
                    categories.map((category, index) => (
                        <div key={index} className="bg-[url(/city.jpg)] max-w-[256px] max-h-[338.11px] h-[50vh] w-[30vh] bg-blend-color bg-[#00000060] rounded-md p-[20px] shadow text-white lg:mb-0 lg:mr-0 mb-[20px] mr-[20px]">
