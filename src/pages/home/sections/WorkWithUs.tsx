...
const WorkWithUs = () => {
    return (
        <div className='min-h-[100vh] py-[50px] px-[5vw]'>
            ...
            <div className="inline-flex mt-[25px] w-full lg:flex-row flex-col justify-between">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:max-w-[45vw] lg:w-fit w-full">
                    <div className="flex flex-col items-center">
                        {/* Image 1 */}
                        <img src="/people-shaking-hands.jpg" alt="people shaking hands"
                            className='max-h-[473px] max-w-[400px] h-[70%] w-[90%]' />
                        {/* Primary Card */}
                        <div className="rounded-2xl bg-primary flex justify-center items-center h-[200px] w-[250px] md:h-[35%] md:w-[70%] md:max-h-[270px] md:max-w-[300px]  mt-8">
                            <div className='flex flex-col items-center'>
                                <div className="rounded-full bg-black flex items-center justify-center h-[60px] w-[60px] md:h-[4vw] md:w-[4vw] max-h-[90px] max-w-[90px]">
                ...
                <div className="lg:max-w-[45vw] lg:w-[647px] w-full max-h-[552px] h-[75vh] flex items-center relative">
